...
public class VideoService {
    ...
    private static final int FRAME_NO = 256; //截取的帧数
    ...
    public Map<String, Object> getVideoLikes(Long videoId, Long userId) {
        ...
        VideoLike videoLike = videoDao.getVideoLikeByVideoIdAndUserId(videoId, userId);
        boolean like = videoLike != null; // 是否点赞
    ...
    public Map<String, Object> getVideoCollections(Long videoId, Long userId) {
        ...
        boolean like = videoCollection != null; // 是否收藏
        Map<String, Object> result = new HashMap<>();
        result.put("count", count);
        result.put("like", like);
        return result;
    ...
    public List<Video> recommend(Long userId) throws TasteException {
        ...
        System.out.println(similarity.userSimilarity(11, 12));//打印用户11和12的相似度，用于测试
        //获取用户邻居
        UserNeighborhood userNeighborhood = new NearestNUserNeighborhood(2, similarity, dataModel); //获取用户邻居，这里取最近的2个用户
        long[] ar = userNeighborhood.getUserNeighborhood(userId);
        //构建推荐器
        Recommender recommender = new GenericUserBasedRecommender(dataModel, userNeighborhood, similarity);
        //推荐视频
        List<RecommendedItem> recommendedItems = recommender.recommend(userId, 5); //获取推荐视频，设置为5个视频
    ...
    public List<VideoBinaryPicture> convertVideoToImage(Long videoId, String fileMd5) throws Exception{
        ...
        String filePath = "C:/Users/Silence/Desktop/tempfile/fileForVideoId/" + videoId + "." + file.getType();
